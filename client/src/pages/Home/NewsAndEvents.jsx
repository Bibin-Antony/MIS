...
=======
          } font-semibold tracking-wider text-2xl text-textSecondary  p-3 transition-all duration-800 border ${
            news && "  border-t-slate-800 border-r-slate-800 border-b-primary"
          } ${!news && "border-b-slate-800 "}`}
...
=======
            ...
            !news && "border-l-slate-800  border-t-slate-800 border-b-primary"
          } ${news && "border-b-slate-800"}`}
>>>>>>> b4beb81d44eb4e02b6692f5b6fea75c2ae8f44c7
        >
          Events
